...
def create_coverage_codes():
    ...
    possible dataset coverage code values) using the API.
...
def coverage_codes():
    '''Return the list of coverage codes from the coverage codes vocabulary.'''
...
class ExampleIDatasetFormPlugin(plugins.SingletonPlugin,
    ...
    def get_helpers(self):
        return {'coverage_codes': coverage_codes}
    ...
    def _modify_package_schema(self, schema):
        # Add our custom coverage_code metadata field to the schema.
        schema.update({
